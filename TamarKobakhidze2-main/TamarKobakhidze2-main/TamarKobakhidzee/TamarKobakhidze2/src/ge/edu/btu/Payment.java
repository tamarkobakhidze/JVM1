...
//ზიპში არის ორი ფაილი ერტი არის ლიბრარი მეორე პროპერტი.პროექტში დაამატებ დირექტორიას სახელად ლიბ და მანდ ჩააგდებ ლიბრარი ფაილს.მერე
    // მერე პროექტის სტრუქტურაში შეხვალ->ლიბრარი->დააჭერ დამატებას და მანდ აირჩევ ისევ იგივე ლაიბრარი ფაილს.
    //მერე კიდე ახალი დირექტორია რეს და მაგას მონიშნავ რესურსად და ჩააგდებ პროპერტი ფაილს და ფაილების მისამართში სწორად ჩაასწორე
////    log4j ის კონფიგურაციის ფაილში ანუ resource ფაილში (რომელსაც ზემოთ დააყენებ იმაში) შეცვალე მე-14 ხაზზე ტოლობის მერე
